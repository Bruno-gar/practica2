                ...
                <form class="text-center" style="color: #757575;" action="semis/insertarsemi.php" method="post">
                    <tr>
                        <td>
                            ...
                            <div class="md-form mt-3">
                                <input type="text" id="Patente-Semi" name="Patente-Semi" class="form-control">
                        ...
                        <td>
                            <!-- Kilometraje -->
                            <div class="md-form mt-3">
                                <input type="number" id="Kilometros-Semi" name="Kilometros-Semi" class="form-control">
                    ...
                    <tr>
                        <td>
                            <!-- Año -->
                            <div class="md-form mt-3">
                                <input type="number" id="Año-Semi" name="Año-Semi" class="form-control">
                        ...
                        <td>
                            <!-- Marca -->
                            <div class="md-form mt-3">
                                <input type="text" id="Marca-Semi" name="Marca-Semi" class="form-control">
